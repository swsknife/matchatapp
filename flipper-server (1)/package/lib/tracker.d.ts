...
declare class ServerCoreTracker {
    track<Event extends keyof TrackerEvents>(event: Event, payload: TrackerEvents[Event]): void;
}
export declare const tracker: ServerCoreTracker;
export {};
